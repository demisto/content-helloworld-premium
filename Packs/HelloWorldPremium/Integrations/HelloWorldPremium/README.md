...
#### Command Example
```!helloworldpremium-say-hello name="Hello Dbot"```
...
### helloworldpremium-search-alerts
***
Search HelloWorldPremium Alerts.
...
#### Command Example
```!helloworldpremium-search-alerts severity="Critical" start_time="3 days" max_results=2 status="ACTIVE"```
        ...
        "Alert": [
            {
                ...
                "name": "Hello World Premium Alert of type Feature",
                "severity": "Critical"
            },
            {
                ...
                "name": "Hello World Premium Alert of type Bug",
                "severity": "Critical"
            }
        ]
    }
...
>|---|---|---|---|---|---|
>| 158cfeb2-84bf-498d-a10d-a55c3445d76e | ACTIVE | Feature | 2020-05-06T20:39:07.000Z | Hello World Premium Alert of type Feature | Critical |
>| c61eec7e-3114-46e2-be71-a82572b98fc3 | ACTIVE | Bug | 2020-05-06T07:49:51.000Z | Hello World Premium Alert of type Bug | Critical |
...
#### Command Example
```!helloworldpremium-get-alert alert_id=695b3238-05d6-4934-86f5-9fff3201aeb0```
...
>### HelloWorldPremium Alert 695b3238-05d6-4934-86f5-9fff3201aeb0
...
### helloworldpremium-update-alert-status
***
...
#### Command Example
```!helloworldpremium-update-alert-status alert_id=695b3238-05d6-4934-86f5-9fff3201aeb0 status="CLOSED"```
...
#### Command Example
```!helloworldpremium-scan-start hostname="example.com"```
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| scan_id | List of Scan IDs. helloworldpremium-scan-start returns "scan_id". | Required | 
...
#### Command Example
```!helloworldpremium-scan-status scan_id="100"```
...
#### Command Example
```!helloworldpremium-scan-results scan_id=100 format=json```
