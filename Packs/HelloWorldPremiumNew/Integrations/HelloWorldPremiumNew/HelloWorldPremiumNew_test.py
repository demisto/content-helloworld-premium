...
def test_say_hello():
    ...
    any external API.
    """
    from HelloWorldPremiumNew import Client, say_hello_command
...
def test_start_scan(requests_mock):
    ...
    """
    from HelloWorldPremiumNew import Client, scan_start_command
...
def test_status_scan(requests_mock):
    ...
    """
    from HelloWorldPremiumNew import Client, scan_status_command
...
def test_scan_results(mocker, requests_mock):
    ...
    the output of the command function with the expected output.
    """
    from HelloWorldPremiumNew import Client, scan_results_command
...
def test_search_alerts(requests_mock):
    ...
    the output of the command function with the expected output.
    """
    from HelloWorldPremiumNew import Client, search_alerts_command
...
def test_get_alert(requests_mock):
    ...
    the output of the command function with the expected output.
    """
    from HelloWorldPremiumNew import Client, get_alert_command
...
def test_update_alert_status(requests_mock):
    ...
    the output of the command function with the expected output.
    """
    from HelloWorldPremiumNew import Client, update_alert_status_command
...
def test_ip(requests_mock):
    ...
    the output of the command function with the expected output.
    """
    from HelloWorldPremiumNew import Client, ip_reputation_command
    from CommonServerPython import Common
...
def test_domain(requests_mock):
    ...
    the output of the command function with the expected output.
    """
    from HelloWorldPremiumNew import Client, domain_reputation_command
    from CommonServerPython import Common
...
def test_fetch_incidents(requests_mock):
    ...
    the output of the command function with the expected output.
    """
    from HelloWorldPremiumNew import Client, fetch_incidents
    ...
    assert new_incidents == [
        {
            'name': 'Hello World Premium New Alert 100',
        ...
        {
            'name': 'Hello World Premium New Alert 200',
            'occurred': '2020-02-17T23:34:23.000Z',
